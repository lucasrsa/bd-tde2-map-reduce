...
//        j.setCombinerClass(ReduceForTradeCount.class);
    ...
    public static class MapForTradeCount extends Mapper<LongWritable, Text, Text, CommodityQtdWritable> {
    ...
    public static class ReduceForTradeCount extends Reducer<Text, CommodityQtdWritable, Text, Text> {
